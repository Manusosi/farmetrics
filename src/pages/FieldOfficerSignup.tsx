...
export function FieldOfficerSignup() {
        ...
        <div className="w-full max-w-lg">
          <Card className="shadow-large">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-2xl">Create Field Officer Account</CardTitle>
              <CardDescription>
                Sign up to manage on-ground agricultural operations
              </CardDescription>
            </CardHeader>
            <CardContent>
